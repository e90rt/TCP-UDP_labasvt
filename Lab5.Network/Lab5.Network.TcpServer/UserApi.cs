...
internal class UserApi : IUserApi
{
    private static readonly ConcurrentDictionary<int, User> userRepository 
        = new ConcurrentDictionary<int, User>() {
            [1] = new User(1, "Талон", true, "Елена Пшеничная","Ожидайте"),
            [2] = new User(2, "Получение паспорта", true, "Ахмет Галиев", "Подойдите к окну"),
            [3] = new User(3, "Справка", true, "Марат Клубников", "Подойдите к окну"),
        };
